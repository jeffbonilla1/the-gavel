...
exports.handler = async (event) => {
  ...
  try {
    ...
    const code = 'TGV-' + session.id.slice(-8).toUpperCase();
    ...
    if (customerEmail) {
      await transporter.sendMail({
        ...
        to: customerEmail,
        subject: 'Your Gavel Access Code',
        html: `
          <div style="background:#0d0f12;padding:40px;font-family:Georgia,serif;max-width:520px;margin:0 auto;">
            ...
            <p style="color:#6a8499;line-height:1.7;margin:0 0 28px;">Save your access code below — you'll need it every time you return to The Gavel. Keep it somewhere safe.</p>
            ...
            <div style="background:#141820;border:1px solid #1a2535;border-radius:8px;padding:20px;margin:0 0 24px;">
              <div style="font-family:monospace;font-size:11px;color:#6a8499;letter-spacing:.1em;text-transform:uppercase;margin-bottom:12px;">Your Legal &amp; Courtroom Toolkit</div>
              <p style="color:#6a8499;font-size:13px;font-family:sans-serif;margin:0 0 12px;line-height:1.6;">Your subscription includes the Legal &amp; Courtroom Toolkit PDF — eight sections on criminal procedure, courtroom drama, and writing legal scenes with authority. Reviewed by Victoria Mills herself.</p>
              <a href="https://thewritersprecinct.com/LegalCourtroomToolkit.pdf" style="display:block;background:#1a2535;color:#4a7fa5;text-decoration:none;font-family:monospace;font-size:13px;padding:12px;border-radius:6px;text-align:center;border:1px solid #4a7fa5;">Download Legal &amp; Courtroom Toolkit →</a>
            </div>
            <a href="https://askthegavel.com" style="display:block;background:#4a7fa5;color:#0d0f12;text-decoration:none;font-family:sans-serif;font-weight:700;font-size:15px;padding:14px;border-radius:8px;text-align:center;">Enter The Gavel →</a>
